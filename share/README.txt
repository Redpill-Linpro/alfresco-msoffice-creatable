...
msoffice-creatable Share component for Alfresco Share
=============================================================

Author: Rasmus Melgaard

This project defines a msoffice-creatable Repo component for SAlfresco Share,
that enables the execution of msoffice-creatable webscripts in the repository. 
...
you'll find two jar files within that folder. The msoffice-creatable-repo.jar needs
to be copied into the Alfresco repository:

  tomcat/webapps/alfresco/WEB-INF/lib/
  
The other file msoffice-creatable-share.jar needs to be copied to the 
corresponding folder in the Share webapp:

  tomcat/webapps/share/WEB-INF/lib/
  
The deployment location has changed recently (with msoffice-creatable Repo)
because the msoffice-creatable Repo now uses Java classes that have to be deployed 
...
The command should build a JAR file named msoffice-creatable-repo.jar or
msoffice-creatable-share.jar in the 'dist' directory within your project.

There also is the msoffice-creatable-dist which builds both jar files and 
...
page. Click 'msoffice-creatable share' in the left hand side navigation.
